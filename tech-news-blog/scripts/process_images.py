...
Usage: python3 process_images.py --post ~/projects/blog/source/_posts/2026-02-04.md
"""
...
def main():
    ...
    if not args.no_upload:
        try:
            ...
            print("Using r2-upload skill for image hosting")
        except ImportError:
            print("Warning: r2-upload skill not available, will only fetch URLs")
            print("Install from: /root/.clawdbot/skills/r2-upload")
